...
namespace HomeTask_2
{
    partial class AboutBox1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "Название продукта: Файловый менеджер";
            ...
            this.labelVersion.Text = "Версия: 1.00";
            ...
            this.labelCopyright.Text = "Авторские права: Водительские кат. А,В";
            ...
            this.labelCompanyName.Text = "Название организации: Галера inc.";
            ...
            this.textBoxDescription.Text = "Описание:\r\n\r\n- Позволяет шариться по дискам и папкам. \r\n- Создавать файлы и измен" +
    "ять имеющиеся файлы.\r\n- Есть кое-какая защита от криворукости.";
            // 
            // okButton
            // 
